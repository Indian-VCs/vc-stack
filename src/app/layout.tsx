  ...
  "@graph": [
    {
      ...
      mainEntity: {
        ...
        itemListElement: [
          { "@type": "ListItem", position: 1, name: "CRM (11 tools)" },
          { "@type": "ListItem", position: 2, name: "Data (12 tools)" },
          { "@type": "ListItem", position: 3, name: "Research (14 tools)" },
          { "@type": "ListItem", position: 4, name: "News (14 tools)" },
          { "@type": "ListItem", position: 5, name: "AI (6 tools)" },
          { "@type": "ListItem", position: 6, name: "Other Tools (21 tools)" },
          { "@type": "ListItem", position: 7, name: "Vibe Coding (4 tools)" },
          { "@type": "ListItem", position: 8, name: "Browser (5 tools)" },
          ...
          { "@type": "ListItem", position: 12, name: "Automation (3 tools)" },
          ...
          { "@type": "ListItem", position: 16, name: "Calendar (4 tools)" },
          {
            "@type": "ListItem",
            position: 17,
            name: "Portfolio Management (4 tools)",
          },
        ],
      },
    },
