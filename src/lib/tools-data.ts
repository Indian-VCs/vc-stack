...
export function buildAllTools(): Tool[] {
  return [
    ...
    t('t-6', 'EverTrace', 'evertrace', 'Relationship intelligence for the networks investors rely on.', 'EverTrace surfaces who-knows-whom across your firm so warm intros stay findable. Relationship-graph data built for venture desks.', 'https://evertrace.ai', 'PAID', 'cat-2', true),
    ...
    t('t-9', 'Notion', 'notion', 'Workspace that doubles as a CRM in early-stage funds.', 'Notion\u2019s flexible databases make it the most common home-grown CRM for small and solo-GP funds in India.', 'https://notion.so', 'FREEMIUM', 'cat-1', false, ['productivity', 'transcription']),
